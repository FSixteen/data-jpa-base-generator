 ...
 * 当且仅当参与计算值类型或函数返回值类型为{@code java.lang.Comparable[2]}时有效.<br>
 * 
 * @author FSixteen
 * @since V1.0.0
 */
...
public @interface Between {
    ...
    /**
     * @see io.github.fsixteen.data.jpa.base.generator.annotations.plugins.Equal#valueProcessorProcessor
     */
    ...
    /**
     * Defines several {@link Between} annotations on the same element.
     *
     * @see Between
     */
    @Target({ FIELD, METHOD })
