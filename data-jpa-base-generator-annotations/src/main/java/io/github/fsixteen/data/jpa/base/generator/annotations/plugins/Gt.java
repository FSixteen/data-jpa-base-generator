...
import io.github.fsixteen.data.jpa.base.generator.annotations.plugins.Gt.List;

/**
 * 大于条件(select * from table_name where column_name &gt; 123).<br>
...
public @interface Gt {
    ...
    /**
     * Defines several {@link Gt} annotations on the same element.
     *
     * @see Gt
     */
    @Target({ FIELD, METHOD })
