...
import io.github.fsixteen.data.jpa.base.generator.annotations.plugins.IsNull.List;

/**
 * 判空快捷注解.
 *
 * <p>
 * 该注解是 {@link NullCheck} 的 is-null 语义快捷包装. 零配置时默认作用于当前字段路径.
 * </p>
 *
 * @author FSixteen
 * @since 1.0.2
...
@Documented
@NullCheck(op = CompareOp.IS_NULL)
@Inherited
public @interface IsNull {
    ...
    /**
     * Defines several {@link IsNull} annotations on the same element.
     *
     * @see IsNull
     */
    @Target({ FIELD, METHOD })
