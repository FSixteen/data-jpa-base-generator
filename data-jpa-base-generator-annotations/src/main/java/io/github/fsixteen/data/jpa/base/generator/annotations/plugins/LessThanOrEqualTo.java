...
import io.github.fsixteen.data.jpa.base.generator.annotations.plugins.LessThanOrEqualTo.List;

/**
 * 小于等于条件(select * from table_name where column_name &lt;= '123').<br>
...
public @interface LessThanOrEqualTo {
    ...
    /**
     * Defines several {@link LessThanOrEqualTo} annotations on the same
     * element.
     *
    ...
    @interface List {
        ...
        /**
         * {@link LessThanOrEqualTo} 集合.<br>
         * 
         * @return {@link LessThanOrEqualTo}[]
         */
