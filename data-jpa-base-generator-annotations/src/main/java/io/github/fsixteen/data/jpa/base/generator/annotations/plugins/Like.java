...
import io.github.fsixteen.data.jpa.base.generator.annotations.plugins.Like.List;

/**
 * 模糊条件, 字符串包含条件(select * from table_name where column_name like '%abc%').<br>
...
public @interface Like {
    ...
    /**
     * Defines several {@link Like} annotations on the same element.
     *
     * @see Like
     */
    @Target({ FIELD, METHOD })
