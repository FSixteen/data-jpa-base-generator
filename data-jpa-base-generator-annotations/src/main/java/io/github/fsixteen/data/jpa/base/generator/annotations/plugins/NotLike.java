...
import io.github.fsixteen.data.jpa.base.generator.annotations.plugins.NotLike.List;

/**
 * 非模糊匹配快捷注解.
 *
 * <p>
 * 该注解是 {@link TextMatch} 的 not-like 语义快捷包装. 零配置时默认等价于
 * “当前字段路径 NOT LIKE 当前字段运行时值”.
 * </p>
 *
 * @author FSixteen
 * @since 1.0.0
...
@Documented
@TextMatch(op = CompareOp.NOT_LIKE)
@Inherited
public @interface NotLike {
    ...
    /**
     * Defines several {@link NotLike} annotations on the same element.
     *
     * @see NotLike
     */
    @Target({ FIELD, METHOD })
