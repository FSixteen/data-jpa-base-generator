...
/**
 * 分割后不包含条件(select * from table_name where column_name not in ('123',
 * ......)).<br>
...
public @interface SplitNotIn {
    ...
    /**
     * Defines several {@link SplitNotIn} annotations on the same element.
     *
     * @see SplitNotIn
     */
    @Target({ FIELD, METHOD })
    ...
    @interface List {
        ...
        /**
         * {@link SplitNotIn} 集合.<br>
         * 
         * @return {@link SplitNotIn}[]
         */
        SplitNotIn[] value();
