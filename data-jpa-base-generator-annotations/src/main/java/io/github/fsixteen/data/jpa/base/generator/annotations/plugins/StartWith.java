...
import io.github.fsixteen.data.jpa.base.generator.annotations.plugins.StartWith.List;

/**
 * 前缀匹配快捷注解。
 *
 * <p>
 * 该注解是 {@link TextMatch} 的 starts-with 语义快捷包装。零配置时默认等价于
...
public @interface StartWith {
    ...
    /**
     * Defines several {@link StartWith} annotations on the same element.
     *
     * @see StartWith
     */
    @Target({ FIELD, METHOD })
