 ...
 * @since 1.0.2
 */
public class Str2LocalTimeConverter extends AbstractString2LocalDateTimeConverter<LocalTime, String> {
    ...
    public String convertToDatabaseColumn(LocalTime attribute) {
        ...
        return this.localTime2Str2(attribute);
    }
    ...
    public LocalTime convertToEntityAttribute(String dbData) {
        ...
        return this.str2LocalTime2(dbData);
    }
