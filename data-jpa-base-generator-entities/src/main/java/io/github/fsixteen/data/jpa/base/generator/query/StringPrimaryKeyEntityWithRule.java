...
import io.github.fsixteen.data.jpa.base.generator.rules.StringUuidIdRule;
...
public class StringPrimaryKeyEntityWithRule implements StringUuidIdRule {
    ...
    public StringPrimaryKeyEntityWithRule() {
    }

    public StringPrimaryKeyEntityWithRule(String id) {
        this.id = id;
    }
