...
public abstract class AbstractComputerBuilderPlugin<A extends Annotation> implements BuilderPlugin<A> {
     ...
     * @return Expression
     */
    private Expression<?> creaateExpression(final AnnotationDescriptor<A> ad, final Args arg, final Object obj, final Object fieldValue, final Root<?> root,
        ...
        switch (arg.type()) {
            ...
            case UDFUNCTION:
                this.getArgsFunctionProcessor(arg).create(ad.getAnno(), arg, obj, ad.getComputerFieldName(), fieldValue, root, query, cb);
            case COLUMN:
            default:
     ...
     * @return Expression[]
     */
    protected Expression<?>[] creaateFunctionExpression(final AnnotationDescriptor<A> ad, final Function function, final Object obj, final Object fieldValue,
        final Root<?> root, final AbstractQuery<?> query, final CriteriaBuilder cb) {
        List<Expression<?>> args = new ArrayList<>();
        for (Args arg : function.args()) {
            args.add(this.creaateExpression(ad, arg, obj, fieldValue, root, query, cb));
        }
    ...
    public boolean checkField(final AnnotationDescriptor<A> ad, final Object fieldValue, final Root<?> root, final AbstractQuery<?> query,
        ...
        switch (ad.getFieldType()) {
            ...
            case COLUMN:
                return true;
            case FUNCTION:
                return !"".equals(ad.getFieldFunction().value());
            case UDFUNCTION:
        ...
        switch (ad.getFieldType()) {
            ...
            case FUNCTION:
                ...
                return cb.<T>function(function.value(), (Class<T>) function.type(),
                    this.creaateFunctionExpression(ad, function, obj, fieldValue, root, query, cb));
            case UDFUNCTION:
                try {
    ...
    public boolean checkFieldValue(final AnnotationDescriptor<A> ad, final Object fieldValue, final Root<?> root, final AbstractQuery<?> query,
        ...
        switch (ad.getValueType()) {
            ...
            case COLUMN:
                return String.class.isInstance(fieldValue);
            case FUNCTION:
                return !"".equals(ad.getValueFunction().value());
            case UDFUNCTION:
