...
public class BadRequestException extends RuntimeException {
    ...
    private Long code = Status.OTHERS_ERROR.get().code();

    private String msg = "异常请求";
     ...
     *                           be writable
     */
    public BadRequestException(StatusInterface status, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
     ...
     *               unknown.)
     */
    public BadRequestException(StatusInterface status, Throwable cause) {
     ...
     *               {@link #getMsg()} method and {@link #getMessage()} method.
     */
    public BadRequestException(StatusInterface status) {
