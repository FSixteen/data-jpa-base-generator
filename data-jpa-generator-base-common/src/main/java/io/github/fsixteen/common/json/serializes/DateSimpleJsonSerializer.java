 ...
 * @since 1.0.1
 */
public class DateSimpleJsonSerializer extends AbstractDateTimeJsonSerializer {
    private static final DateTimeFormatter DTF = DateTimeFormatter.ofPattern("yyyyMMdd", Locale.getDefault()).withZone(ZoneId.systemDefault());
