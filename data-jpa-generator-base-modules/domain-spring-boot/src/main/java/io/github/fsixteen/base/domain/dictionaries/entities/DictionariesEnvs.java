...
/**
 * 实体: 系统字典信息-系统字典环境编码.<br>
 * 
 * @author FSixteen
 * @since 1.0.1
 */
@Entity
@Table(name = DictionariesEnvs.TABLE_NAME, indexes = { @Index(name = "idx_1886f7b2435", unique = true, columnList = "code") })
...
public class DictionariesEnvs extends BaseEntity<Integer> {
    ...
    public static final String TABLE_NAME = "fsn_dictionaries_envs";
    public static final String TABLE_DESC = "系统字典信息-系统字典环境编码";
