...
/**
 * 请求实体: 更新请求: 系统字典信息-系统字典环境编码.<br>
 * 
 * @author FSixteen
 * @since 1.0.1
 */
@ApiModel(value = "请求更新实体-系统字典信息-系统字典环境编码")
@Schema(description = "请求更新实体-系统字典信息-系统字典环境编码")
@JsonIgnoreProperties(ignoreUnknown = true, value = { "hibernateLazyInitializer", "handler" })
public class DictionariesEnvsUpdateQuery extends DictionariesEnvsInsertQuery implements IdEntity<Integer> {
    ...
    public DictionariesEnvsUpdateQuery withId(Integer id) {
        this.id = id;
        return this;
    }
